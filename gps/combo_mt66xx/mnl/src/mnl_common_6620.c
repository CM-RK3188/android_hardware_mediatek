...
#define MNL_MSG(fmt, ...) ALOGD("%s: " fmt, __FUNCTION__ ,##__VA_ARGS__)
#define MNL_MON(fmt, ...) ALOGD("%s: " fmt, __FUNCTION__ ,##__VA_ARGS__)
#define MNL_ERR(fmt, ...) ALOGE("%s: " fmt, __FUNCTION__ ,##__VA_ARGS__)
#else /***********************************************************************/
...
int set_prop(MNL_CONFIG_T* prConfig, char* key, char* val)
{
    ...
    else if (!strcmp(key, "test.mode"))
    {
        prConfig->test_mode = atoi(val);
    }
    ...
    else if (!strcmp(key, "TCXO_PPB"))
    {
        prConfig->tcxo_ppb = atoi(val);
    }
    else if (!strcmp(key, "TCXO_TYPE"))
    {
        prConfig->tcxo_type = atoi(val);
    }
    else if (!strcmp(key, "TCXO_FEQ"))
    {
        prConfig->tcxo_freq = atoi(val);
    }
    return 0;
}
/*****************************************************************************/
