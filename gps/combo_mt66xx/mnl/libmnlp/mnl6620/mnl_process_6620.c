...
/* FIXME!! George Kuo: 26MHz TCXO on EVBv1!!! */
    ...
    init_cfg.hw_Clock_Freq = mnl_config.tcxo_freq;             // 26MHz TCXO
    init_cfg.hw_Clock_Drift = mnl_config.tcxo_ppb;             // 0.5ppm TCXO    
    ...
    */
    ...
    //init_cfg.u1ClockType = 0xFF;//0xFE;    // wide-range XTAL
    	...
    	init_cfg.u1ClockType = mnl_config.tcxo_type;
    ...
    */
    ...
    MNL_MSG("Do not close dsp_fd (%d)", dsp_fd);		
    //close(dsp_fd);	
#else
