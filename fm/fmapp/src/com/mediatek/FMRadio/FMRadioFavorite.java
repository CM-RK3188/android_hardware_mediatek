            ...
            new View.OnCreateContextMenuListener() {
                public void onCreateContextMenu(ContextMenu menu, View view, ContextMenu.ContextMenuInfo menuInfo) {
                    ...
                    if (FMRadioStation.STATION_TYPE_SEARCHED == stationType) {
                        // Searched station.
                        menu.add(0, CONTMENU_ID_ADD, 0, getString(R.string.add_to_favorite1));
                    } else {
                        // Favorite station.
                        menu.add(0, CONTMENU_ID_EDIT, 0, R.string.contmenu_item_edit);
                        menu.add(0, CONTMENU_ID_DELETE, 0, getString(R.string.contmenu_item_delete1));
                    }
                }
            }
        );
    ...
    public boolean onContextItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            if (FMRadioStation.getStationCount(mContext, FMRadioStation.STATION_TYPE_FAVORITE)
                ...
                Toast.makeText(mContext, getString(R.string.toast_favorite_full1), Toast.LENGTH_SHORT).show();
                break;
            }
